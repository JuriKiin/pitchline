...
export const initialPlayers7: Player[] = [
  ...
  { id: 'p2', name: 'Player 2', positionName: 'DEF', position: { x: 75, y: 30 }, isBenched: false },
  { id: 'p3', name: 'Player 3', positionName: 'DEF', position: { x: 25, y: 30 }, isBenched: false },
  { id: 'p4', name: 'Player 4', positionName: 'MID', position: { x: 80, y: 60 }, isBenched: false },
  { id: 'p5', name: 'Player 5', positionName: 'MID', position: { x: 50, y: 50 }, isBenched: false },
  { id: 'p6', name: 'Player 6', positionName: 'MID', position: { x: 20, y: 60 }, isBenched: false },
  { id: 'p7', name: 'Player 7', positionName: 'FWD', position: { x: 50, y: 85 }, isBenched: false },
  { id: 's1', name: 'Sub 1', positionName: 'SUB', position: { x: 0, y: 0 }, isBenched: true },
  { id: 's2', name: 'Sub 2', positionName: 'SUB', position: { x: 0, y: 0 }, isBenched: true },
];
...
export const initialPlayers6: Player[] = [
  { id: 'p1', name: 'Player 1', positionName: 'GK', position: { x: 50, y: 10 }, isBenched: false },
  { id: 'p2', name: 'Player 2', positionName: 'DEF', position: { x: 70, y: 35 }, isBenched: false },
  { id: 'p3', name: 'Player 3', positionName: 'DEF', position: { x: 30, y: 35 }, isBenched: false },
  { id: 'p4', name: 'Player 4', positionName: 'MID', position: { x: 75, y: 65 }, isBenched: false },
  { id: 'p5', name: 'Player 5', positionName: 'MID', position: { x: 25, y: 65 }, isBenched: false },
  { id: 'p6', name: 'Player 6', positionName: 'FWD', position: { x: 50, y: 85 }, isBenched: false },
  { id: 's1', name: 'Sub 1', positionName: 'SUB', position: { x: 0, y: 0 }, isBenched: true },
];
